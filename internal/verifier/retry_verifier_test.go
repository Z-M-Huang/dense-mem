...
func (s *stubConfigProvider) GetArgonMemoryKB() int                  { return 65536 }
func (s *stubConfigProvider) GetArgonTime() int                      { return 1 }
func (s *stubConfigProvider) GetArgonThreads() int                   { return 4 }
func (s *stubConfigProvider) GetRateLimitPerMinute() int             { return 100 }
func (s *stubConfigProvider) GetAdminRateLimitPerMinute() int        { return 1000 }
...
func (s *stubConfigProvider) GetAdminQueryTimeoutSeconds() int       { return 30 }
func (s *stubConfigProvider) GetAdminQueryRowCap() int               { return 1000 }
